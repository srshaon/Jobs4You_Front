        ...
        <div>
            <div className='d-flex' >
                <div className='flex-grow-1'>
                    <img style={{ height: 580 }} className="d-block w-100 img-fluid " src="https://cresuma.com/career-guides/content/images/2022/02/How-to-write-a-cover-letter-2022--1-.jpg" alt="" />
                </div>
            </div>
...

                {
                    ...
                    <div className='ms-2 me-5 row row-cols-lg-2 row-cols-md-2 row-cols-1'>
                        <div className='mt-4' style={{ borderRight: "2px solid gray" }}>
                            <h1 style={{
                                color: "brown"
                            }}>ESSENTIAL COVER LETTER HUNTING TIPS </h1>
                            ...
                            <div id="guidecontainer">
                                ...
                                <div class="job-image">
                                    ...
                                    <h4 className='mt-4'>
                                        ...
                                        Suggested Links Of Cover-Letter Template
                                    </h4>
                                    <h1><IoIosArrowDropdownCircle /></h1>
                                    <img style={{ height: 370, width: 300 }} src="https://i.ytimg.com/vi/lq6aGl1QBRs/maxresdefault.jpg" alt="" />
                                    ...
                                    <div class="info">
                                        ...
                                        <ul>
                                            <li >
                                                <a style={{ color: "white" }} target="blank" href="https://zety.com/cover-letter-templates">Zety</a>
                                            </li>
                                            <li>
                                                <a style={{ color: "white" }} target="blank" href="https://www.livecareer.com/cover-letter/examples">Jobseeker</a>
                                            </li>
                                            <li>
                                                <a style={{ color: "white" }} target="blank" href="https://www.livecareer.com/">LiveCareer</a>
                                            </li>
                                            <li>
                                                <a style={{ color: "white" }} target="blank" href="https://jnee.uk/uk/expense-reporting-software?utm_campaign=16141145246&utm_source=google&utm_medium=cpc&gclid=CjwKCAiAgbiQBhAHEiwAuQ6BkgME8N6S4o90y73PklLcYltrX8gsd4F9ql8202kyTNxxvenSj8zgDxoC-14QAvD_BwE">Jnee</a>
                                            </li>
                                            <li>
                                                <a style={{ color: "white" }} target="blank" href="https://www.seek.com.au/career-advice/article/free-cover-letter-template">Seek</a>
                                            </li>
