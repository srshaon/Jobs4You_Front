                                        ...
                                        <div class="profile-form-container">
                                            ...
                                            <div class="profile-form-inputs">
                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    <input className='profile-form-input' placeholder="Company Name" defaultValue={''} {...register("cname", { required: true })} />
                                                    <input className='profile-form-input' placeholder="Founded On" defaultValue={''} {...register("founded", { required: true })} />
                                                </div>

                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    <input className='profile-form-input' placeholder="Country Of Origin" defaultValue={''} {...register("country", { required: true })} />
                                                    <input className='profile-form-input' placeholder="Industry" defaultValue={''} {...register("industry", { required: true })} />
                                                </div>
                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    <input className='profile-form-input' placeholder="Website" defaultValue={''} {...register("website", { required: true })} />
                                                    <input className='profile-form-input' placeholder="Business License No." defaultValue={''} {...register("bln", { required: true })} />
                                                </div>
                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    <input className='profile-form-input' placeholder="Official Email" defaultValue={''} {...register("email", { required: true })} />
                                                    <input className='profile-form-input' placeholder="Contact No." defaultValue={''} {...register("contact", { required: true })} />
                                                </div>

                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    <input className='profile-form-input' placeholder="Number Of Employees" defaultValue={''} {...register("noe", { required: true })} />
                                                    <input className='profile-form-input' placeholder="Number of Branch/es" defaultValue={''} {...register("nob", { required: true })} />
                                                </div>

                                                <div className='profile-form-input-pair d-flex justify-content-center'>

                                                    <textarea rows={4} className='profile-form1-headquarter-textarea' placeholder="Headquarter" defaultValue="" {...register("headquarter", { required: true })} />
                                                </div>
                    ...
                    (condition === 'user') && (
                        <div>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div class="profile-form-container">
                                    <h6>This is conditional Form</h6>
                                    <h2>User Profile</h2>
                                    <div class="profile-form-inputs">
                                        <div className='profile-form-input-pair d-flex justify-content-center'>
                                        ...
                                        <div className='profile-form-input-pair d-flex justify-content-center'>
                                            ...
                                            <textarea rows={2} className='profile-form1-address-textarea' placeholder="Address" defaultValue="" {...register("address", { required: true })} />
                                        </div>
