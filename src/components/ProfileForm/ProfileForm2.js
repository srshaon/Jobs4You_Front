                                        ...
                                        <div class="profile-form-container">
                                            ...
                                            <div class="profile-form-inputs">
                                                <div className='profile-form-input-pair d-flex justify-content-center'>
                                                    ...
                                                    <textarea rows={8} className='profile-form2-bio-textarea' placeholder="About Company Culture" defaultValue="" {...register("acc", { required: true })} />
                                                </div>
                                                <br />
                                                <div className='profile-form-input-pair d-flex justify-content-center'>

                                                    <textarea rows={5} className='profile-form2-hobby-textarea' placeholder="Company Vision" defaultValue="" {...register("vision", { required: true })} />
                                                </div>
                                                <br />
                                                <div className='profile-form-input-pair d-flex justify-content-center'>
