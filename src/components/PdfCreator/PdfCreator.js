...
const PdfCreator = () => {
  ...
  const onSubmit = data => {
    ...
    setDownloading(true)
    axios.post('https://afternoon-headland-45054.herokuapp.com/createPdf', info)
      .then(response => {
        axios.get('https://afternoon-headland-45054.herokuapp.com/fetch-pdf', { responseType: 'blob' })
          .then((res) => {
