...
const PdfCreator = () => {
     ...
     const handleShow = () => setShow(true);
       ...
       const onSubmit = data =>{
         ...
         axios.post('https://still-cliffs-68775.herokuapp.com/createPdf',info)
         .then(response => { 
           axios.get('https://still-cliffs-68775.herokuapp.com/fetch-pdf', { responseType: 'blob' })
           .then((res) => {
    ...
    return (
        ...
        <ModalMessage show={show} setShow={setShow} message={'Submitted'} />
          ...
          <h2 className="text-center text-primary mb-4">Create A short Resume</h2>
     ...
     <input className="form-control mt-2"  type="number" placeholder="Phone" {...register("phone",{ required: true })} />
